...
namespace Tutorial1.Controllers
{
    public class MoviesController : Controller
    {
        static List<Movie> movies = new List<Movie>
        {
                ...
                new Movie { Author = "Todd Phillips", Genre = "Action, Adventure", Name = "Fast & Furious Presents: Hobbs & Shaw",
                ...
                new Movie { Author = "Todd Phillips", Genre = "Adventure, Animation, Drama, Family, Musical", Name = "The Lion King",
                ...
                new Movie { Author = "Todd Phillips", Genre = "Adventure , Family , Fantasy",Name = "Maleficent: Mistress of Evil",
